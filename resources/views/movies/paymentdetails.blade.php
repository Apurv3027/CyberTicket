    ...
    <div class="container" style="margin-top:15px; margin-left:120px; margin-bottom:40px; ">
        <div class="row">
            ...
            <div class="w-full md:max-w-md mt-6 px-6 py-4 shadow-md overflow-hidden sm:rounded-lg" style="border-radius:30px; min-height:550px; background-color:#0C0E10;">
                <div>
                    <center><h2 style="font-size:25px;"><b>Payment Summary</b></h2></center>
                </div>
                <div class="mt-4" style="margin-top:50px; margin-left:20px;">
                    ...
                    <input type="hidden" id="link" name="link" value="http://127.0.0.1:8000/movies/{{$datams->getMovie->slug}}/{{$datams->id}}/select-seats"/>
                    <h1 class="block text-sm text-gray-700" style="font-size:22px; font-weight:bolder; margin-bottom:5px;">Seat No.</h1>
                ...
                <div class="mt-4" style="margin-top:20px; margin-left:20px;">
                    <h1 class="block text-sm text-gray-700" style="font-size:22px; margin-right:300px; margin-bottom:5px; font-weight:bolder;">Screen</h2>
                ...
                <div class="row" style="margin-top:20px; margin-left:5px; margin-right:0px;">
                    <div class="col-sm-2">
                        <h1 class="block text-sm text-gray-700" style="font-size:18px; margin-right:; margin-bottom:5px; font-weight:bolder; text-align: left;">Fees</h2>
                    </div>
                    <div class="col-sm-6"></div>
                    <div class="col-sm-4"> 
                        <h2 class="block text-sm text-gray-700" style="font-size:18px; margin-right:10px; font-weight:bolder; float:right; text-align:right;">Rs. {{$tickets->totalcost}}.00</h2>
                    </div>
                </div>
                <div class="row" style="margin-top:20px; margin-left:5px; margin-right:0px;">
                    <div class="col-sm-5">
                        <h1 class="block text-sm text-gray-700" style="font-size:18px; margin-right:; margin-bottom:5px; font-weight:bolder; text-align: left;">Booking Charge</h2>
                    </div>
                    <div class="col-sm-3"></div>
                    <div class="col-sm-4"> 
                        <h2 class="block text-sm text-gray-700" style="font-size:18px; margin-right:10px; font-weight:bolder; float:right; text-align:right;">Rs.<span id="bookingcharge"></span></h2>
                    </div>
                </div>
                <div class="row" style="margin-top:20px; margin-left:5px; margin-right:0px;">
                    <div class="col-sm-5">
                        <h1 class="block text-sm text-gray-700" style="font-size:18px; margin-right:; margin-bottom:5px; font-weight:bolder; text-align: left;">GST @18%</h2>
                    </div>
                    <div class="col-sm-3"></div>
                    <div class="col-sm-4"> 
                        <h2 class="block text-sm text-gray-700" style="font-size:18px; margin-right:10px; font-weight:bolder;  text-align:right;">Rs.<span id="gst"></span></h2>
                    </div>
                </div>
                ...
                <div class="row" style="margin-top:30px; margin-left:5px; margin-right:0px;">
                    <div class="col-sm-6">
                        <h1 class="block text-sm text-gray-700" style="font-size:20px; margin-right:; margin-bottom:5px; font-weight:bolder; text-align: left;">Total Payable Amount</h2>
                    </div>
                    <div class="col-sm-2"></div>
                    <div class="col-sm-4"> 
                        <h2 class="block text-sm text-gray-700" style="font-size:20px; margin-right:10px; font-weight:bolder; float:right; text-align:right;">Rs.<span id="total"></span></h2>
                    </div>
                </div>
                <form action="{{ route('payment') }}" method="POST" >
                    ...
                    <div class="row">
                        <div class="col-sm-3"></div>
                        <div class="col-sm-6">
                            <center><button type="submit" id="btn" name="btn" style="margin-top:40px; margin-bottom:0px; margin-left:15px; font-color:#dfscds; font-weight:bolder; border-radius:5px; padding: 7px; font-size: 20px; color:#ffffff; border : 0px; font-family:Nunito, ui-sans-serif, system-ui; outline: none; background-color:#9370DB;">Make Payment</Button></center>
                        </div>
                            <div class="col-sm-3"></div>
                    </div>
                    <script src="assets/js/razorpay.js"
                                            data-key="{{ env('RAZOR_KEY') }}"
                                            data-amount = "{{$tickets->totalpay}}00"
                                            data-buttontext= ""
                                            data-name="Online Movie Ticket Booking"
                                            data-description="{{$datams->getMovie->name}}"
                                            data-image="{{ ('assets/images/logo.png') }}"
                                            data-prefill.name="{{Auth::user()->name}}"
                                            data-prefill.email="{{Auth::user()->email}}"
                                            data-prefill.contact="{{Auth::user()->phone}}"
                                            data-theme.color="#1a1a1a"
                                            id = "paymentWidget"
                                        >
                                        </script>
                </form>
