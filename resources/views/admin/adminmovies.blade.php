                    ...
                    <div class="col-lg-11 col-md-11 col-sm-11 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="{{ url('/uploadmovies') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="mt-4">
                                        ...
                                        <x-jet-input id="length" class="block mt-1 w-full" type="text"
                                            name="length" :value="old('length')" required autofocus autocomplete="off" />
                                    </div>
                                    ...
                                    <div class="mt-4">
                                        ...
                                        <x-jet-input id="rating" class="block mt-1 w-full" type="text"
                                            name="rating" :value="old('rating')" required autofocus autocomplete="off" />
                                    </div>
                                    ...
                                    <div class="mt-4">
                                        ...
                                        <x-jet-input id="imdb" class="block mt-1 w-full" type="number"
                                            step="any" min="0" max="10" name="imdb"
                                            :value="old('imdb')" required autofocus autocomplete="off" />
                                    </div>

                                    <div class="mt-4">
                                        <x-jet-label for="rt" value="{{ __('Rotten Tomatoes Rating') }}" />
                                        <x-jet-input id="rt" class="block mt-1 w-full" type="number"
                                            min="0" max="100" name="rt" :value="old('rt')" required
