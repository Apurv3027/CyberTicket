                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="d-flex justify-content-end align-items-center">
                                            <a href="{{ url('/adminmovies') }}">
                                                <x-jet-button class="ml-4">{{ __('Add') }}</x-jet-button>
                                            </a>
                                            <a href="#" onclick="window.location.href='{{ route('download.currentmoviedata') }}'">
                                                <x-jet-button class="ml-4"><i class="fa fa-download mr-2"></i>Movie Data</x-jet-button>
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    @foreach ($data as $index => $data)
                                        <tr>
                                            ...
                                            <td style="padding: 20px"><a
                                                    href="{{ url('/updatemovie', $data->id) }}"><button
                                                        data-toggle="modal"
