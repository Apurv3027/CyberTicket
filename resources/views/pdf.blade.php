...
<body style="bg-color:#1a1a1a;">
    <div>
        ...
        <table style="margin-left: auto; margin-right: auto; margin-bottom:20px;">
            <tr>
                <td><img src="{{ public_path('moviesimage/' . $datams->getMovie->image) }}"
                        style="width: 200px; height: 250px; overflow: hidden; border-radius: 10px; float:center;">
            </tr>
        </table>
        <table style="margin-top:280px;">
            <tr>
                <td style="padding: 0px;padding-right: 7px;font-size: 25px ;margin: 30px;">
                    {{ $datams->getMovie->rating }}</td>
        ...
        <table style="margin-bottom:-200px">
            <tr>
                <td><img src="{{ 'assets/images/direction.jpg' }}"
        ...
        <table>
            ...
            <tr>
                <td style="padding: 10px;padding-left: 10px; padding-top:-5px; font-size: 40px;font-weight: bold">
                    {{ date('g:i A', strtotime($datams->showtime)) }}</td>
            </tr>
        </table>
        <table>
            <tr>
            ...
            <td style="padding: 0px;padding-left: 10px; font-size: 20px;font-weight: bold;">
                {{ $datams->getScreen->screenname }}</td>
            </tr>
            <tr>
                <td style="padding: 5px; padding-left: 0px; font-size: 25px;">Seats</td>
            </tr>
            <td
                style="padding: 0px;padding-left: 10px; padding-bottom: 25px; padding-right:10px; font-size: 20px;font-weight: bold;">
                {{ $tickets->seatnames }}</td>
            </tr>
        </table>
        <table style="margin-left: auto; margin-right: auto;">
            ...
            <br>
            <tr>
                <th style="margin-left:auto; margin-right:auto;"><img src="{{ 'assets/images/CyberTicketzQR.png' }}"
                        alt="" style="width: 150px; height: 150px; overflow: hidden; border-radius: 10px;"></th>
            </tr>
        </table>
    </div>
</body>
